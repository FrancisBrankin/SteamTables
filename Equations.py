...
class Polytropic():
    ...
    def equation_finder(self):
        ...
        for i in range(0,9):
            ...
            checkf = [self.w_12, self.P_1, self.P_2, self.v_2, self.v_1, self.T_2, self.T_1]
            null = 0
            for a in checkf:
                if a == None:
                    null += 1
            ...
            checkh = [self.s_1, self.s_2, self.T_2, self.c_v, self.T_1, self.v_2, self.v_1]
            null = 0
            for a in checkh:
                if a == None:
                    null += 1
            ...
            checki = [self.s_1, self.s_2, self.T_2, self.c_v, self.T_1, self.n, self.R]
            null = 0
            for a in checki:
                if a == None:
                    null += 1
...
class Flow_Processes():
    ...
    def all_variables(self):
        if self.q_12 == None:
            self.q_12 = self.w_12 +  self.h_2 - self.h_1 +0.5*(self.C_2 ** 2 + self.C_1 ** 2) + 9.81*(self.z_2 - self.z_1)
            return self.q_12

        elif self.w_12 == None:
            self.w_12 = self.q_12 - (self.h_2 - self.h_1 +0.5*(self.C_2 ** 2 + self.C_1 ** 2) + 9.81*(self.z_2 - self.z_1))
            return self.q_12
        
        elif self.h_2 == None:
            self.h_2 = self.q_12 - self.w_12 + self.h_1 - 0.5*(self.C_2 ** 2 + self.C_1 ** 2) - 9.81*(self.z_2 - self.z_1)
            return self.h_2

        elif self.h_1 == None:
            self.h_1 = - self.q_12 + self.w_12 + self.h_2 + 0.5*(self.C_2 ** 2 + self.C_1 ** 2) + 9.81*(self.z_2 - self.z_1)
            return self.h_1

        elif self.C_2 == None:
            self.C_2 = np.sqrt((2*(self.q_12 - self.w_12 - 9.81*(self.z_2 - self.z_1)) + self.C_1 ** 2))
            return self.C_2

        elif self.C_1 == None:
            self.C_1 = np.sqrt((2*( - self.q_12 + self.w_12 + 9.81*(self.z_2 - self.z_1)) + self.C_2 ** 2))
            return self.C_1

        elif self.z_2 == None:
            self.z_2 = (self.q_12 - self.w_12 - 0.5*(self.C_2 ** 2 + self.C_1 ** 2))/9.81 + self.z_1
            return self.z_2

        elif self.z_1 == None:
            self.z_2 = - (self.q_12 - self.w_12 - 0.5*(self.C_2 ** 2 + self.C_1 ** 2))/9.81 + self.z_2
            return self.z_2
    ...
    def equation_finder(self):
        called = None
        for i in range(0,1):
            checka = [self.q_12,self.w_12,self.h_2,self.h_1,self.C_1,self.C_2,self.z_1,self.z_2]
            null = 0
            for a in checka:
                if a == None:
                    null += 1
